        ...
        <table className="w-full">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              ...
              <th className="text-left px-4 py-3 text-xs font-medium text-gray-500 uppercase">Periode</th>
            ...
            {items.map((item: any) => (
              <tr key={item.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">
                  {item.is_active ? <span className="flex items-center gap-1 text-xs text-green-700"><Eye className="w-3 h-3" /> Aktif</span> : <span className="flex items-center gap-1 text-xs text-gray-500"><EyeOff className="w-3 h-3" /> Nonaktif</span>}
                </td>
