  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-fg">Hubungi Kami</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="bg-surface rounded-xl border border-border p-6">
            <h3 className="font-semibold text-fg mb-4">Informasi Kontak</h3>
            <div className="space-y-4">
              <div className="flex gap-3">
                <MapPin className="w-5 h-5 text-primary-500 mt-0.5" />
                <div>
                  <p className="font-medium text-fg">Alamat</p>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <p className="font-medium text-fg">Telepon</p>
                  <p className="text-sm text-fg-secondary">{profile?.telp || '(021) 12345678'}</p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-fg-secondary">{profile?.email || 'info@desa.id'}</p>
                </div>
              </div>
              <div className="flex gap-3">
                <Clock className="w-5 h-5 text-primary-500 mt-0.5" />
                <div>
                  <p className="font-medium text-fg">Jam Kerja</p>
                  <p className="text-sm text-fg-secondary">Senin - Jumat: 08:00 - 16:00</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-surface rounded-xl border border-border p-6">
          <h3 className="font-semibold text-fg mb-4">Lokasi</h3>
          <div className="bg-gray-100 rounded-lg h-64 flex items-center justify-center text-fg-muted">
